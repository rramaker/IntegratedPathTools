#' @name genes
#' @title Pathway Gene Info
#' @description This data set contains all genes involved in KEGG, Reactome, and SMPDB pathways 
#' and indicate which genes are involved in which pathway.
#' @docType data
#' @format A dataframe with 9667 rows and 2236 variables.  All variables are individual pathways.
#' @note 
