#' @name metabolites
#' @title Pathway Metabolites
#' @description This data set contains all metabolites involved in KEGG, Reactome, and SMPD pathways 
#' and indicates which metabolites are involved in which pathway.
#' @docType data
#' @format A dataframe with 2947 rows and 1976 variables.  All variables are individual
#' pathways.
#' @note 
