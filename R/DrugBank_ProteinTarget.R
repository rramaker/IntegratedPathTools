#' @name DrugBank_ProteinTarget
#' @title Pathway Bank protein target info
#' @description This data set contains all protein targets of DrugBank drugs
#' @docType data
#' @format A dataframe with 2429 rows and 5022 variables.  All variables are individual drugs.
#' @note 
