#' Perform post hoc permutation analysis on pathway over-resentation
#'
#' This takes dataframes with rna and metabolite info and performs permutation analysis of pathway over-representation.
...
#' @param pathway.id Pathway id to perform permutation on.  ("hsa04727")
...
#' @param numSims Integer indicating the number of permutation simulations to perform.  Defaults to 10000
#' @keywords IPA
#' @import ggplot2
#' @export
#' @return Returns an histogram with pathway representation frequencies from permutation analysis.
#' @examples
#' data(kData)
#' data(rData)
#' permutePath("hsa04727", geneResult=kData, metaboliteResult=rData, 
#'      geneCutoff=0.1, metaboliteCutoff=0.219)
#' @note
#' permutePath is powered by the following open source databases.  Commercial use and/or redistribution may restricted.  Please see respective terms of use pages and citations for more details.
#' 
#' KEGG
#' 
...
permutePath = function(pathway.id, geneResult=NULL, metaboliteResult = NULL, geneCutoff=NULL, metaboliteCutoff=NULL, seed = 1990, numSims=10000){
