#' @name pathIndex
#' @title Pathway ID to name conversion table
#' @description This data set contains all pathway names for a given pathway ID
#' @docType data
#' @format A dataframe with 2247 rows and 1 variable. 
#' @note 
